            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('anggota/prostam_simpanan'); ?>" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="angsuran" class="form-control" id="angsuran" value="<?php echo $angmaxtam; ?>" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="tanggal_simpan" id="tanggal_simpan">
